...
export default function Home(props) {
  ...
  return (
    <>
      ...
      <CSSTransition in={exitTrigger} timeout={400} classNames='fade' onExited={() => history.push('/ocular-summit')}>
        <div className='page home'>
          <h1>Welcome to</h1>
          <div className='home-hero-logo'>Site Logo</div>
          {/* <img src={props.screenWidth ? logoMobile : logo} alt='Dry Eyeland' className='dry-eyeland-logo' /> */}
          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequuntur nesciunt fugiat...</p>
          <div className='button get-started' onClick={startButton}>
            Get Started
          </div>
        </div>
      </CSSTransition>
